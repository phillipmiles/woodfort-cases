  ...
  return (
    <div>
      <ContentWidth>
        ...
        <h2>OVERVIEW</h2>
        <p>
          This website is operated by Woodfort Cases. Throughout the site, the
          terms “we”, “us” and “our” refer to Woodfort Cases. Woodfort Cases
        ...
        <p>
          ...
          any illegal or unauthorised purpose nor may you, in the use of the
        ...
        <p>
          ...
          Refund Policy: www.woodfort.com.au/policies/refund-policy We have made
          every effort to display as accurately as possible the colours and
        ...
        <p>
          ...
          www.woodfort.com.au/policies/refund-policy
        </p>
        ...
        <p>
          ...
          www.woodfort.com.au/policies/privacy-policy
        </p>
        ...
        <p>
          You agree to indemnify, defend and hold harmless Woodfort and our
        ...
        <p>
          Our contact information is posted below: Woodfort Cases
          contact@woodfort.com.au abn 82 848 641 622
        </p>
      </ContentWidth>
    </div>
  );
