  ...
  return (
    <div>
      <ContentWidth>
        <h1>Refund policy</h1>
        <p>
          Woodfort Cases is unable to offer a return or exchange for customers
          who change their mind on a purchase.
        </p>

        <h2>Warranty, Damages and Defects</h2>
        <p>
          Woodfort Cases does offer 3 months warranty on its cases. If a case if
          found to be defective or become damaged through reasonable use of the
          goods within this time period then the customer will be eligible for a
          return or exchange.
        </p>

        <p>
          Reasonable use of the goods does not include the product interacting
          with water or damage due to exposure from direct sunlight.
        </p>
        ...
        <p>
          To notify us of an issue with your order, contact us at
        ...
        <p>
          ...
          back to Woodfort Cases without first requesting a return will not be
          accepted.
        </p>
        ...
        <p>
          ...
          or unused, and in its original packaging. You’ll also need the receipt
        ...
        <p>
          ...
          return, please contact us at contact@woodfort.com.au.
        </p>
      </ContentWidth>
    </div>
  );
